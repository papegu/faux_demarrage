...
def save_indices_to_excel(df, folder, filename="powerdavindices.xlsx"):
    """Sauvegarde le DataFrame df dans un fichier Excel dans folder."""
...
# Sauvegarder le tableau final dans un fichier Excel
save_indices_to_excel(df_all, folder_path)
